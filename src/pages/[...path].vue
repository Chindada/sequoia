...
<template>
  <div
    class="bg-surface-0 dark:bg-surface-950 flex h-screen justify-center px-12 md:px-20 xl:px-[20rem]"
  >
    <div class="flex min-h-[35rem] flex-col items-center justify-center gap-8">
      <svg
        fill="none"
        height="140"
        viewBox="0 0 208 140"
      ...
      <div class="flex w-full flex-col items-center gap-4">
        <h1
          class="text-surface-900 dark:text-surface-0 text-center text-5xl leading-tight font-bold"
        >
          Page Not Found
        </h1>
        <p class="text-surface-500 dark:text-surface-300 text-center text-lg leading-normal">
          Sorry, we couldn't find the page.
        </p>
      </div>
      <Button icon="pi pi-arrow-left" label="Back to Home" text @click="goHome" />
    </div>
  </div>
</template>
